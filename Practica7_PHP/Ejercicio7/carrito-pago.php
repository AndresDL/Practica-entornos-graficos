...
<html>
    ...
    <body>
        ...
        method="post">
            <fieldset>
            <legend class="prod"><strong>FINALIZAR COMPRA</strong> <a href="#"
            onClick="javascript:window.open('https://www.paypal.com/cgi-
            bin/webscr?cmd=xpt/popup/OLCWhatIsPayPal-outside','olcwhatispaypal','toolbar=no,
            ...
            bgcolor="#EABB5D" style=" border-color:#000000; border-style:solid;border-
            width:1px;">
            <tr>
